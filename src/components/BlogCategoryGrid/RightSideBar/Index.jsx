...
import RightCardCont from "./RightCardCont/Index";
            ...
            <div className={styles.leftsinglepost}>
              ...
              <div className={styles.content}>
                <p className={styles.para}>
                  ...
                  celebrating life in the kitchen through home cooking and
                  kitchen intelligence.
                </p>
                <p>
                  We've reviewed and ranked all of the best smartwatches on the
                  market right now, and we've made a definitive list of the top
                  10 devices you can buy today. One of the 10 picks below may
                ...
                <h3 className={styles.SinglepostHeading}>
                  Lorem ipsum dolor sit amet consectetur.
                </h3>
                <p className={styles.para1}>
                  Throughout our review process, we look at the design,
                  features, battery life, spec, price and more for each
                  smartwatch, rank it against the competition and enter it into
                  the list you'll find below.
                </p>
                <img src={blog20} alt="" />
                <p className={styles.para1}>
                  Tortor, lobortis semper viverra ac, molestie tortor laoreet
                  amet euismod et diam quis aliquam consequat porttitor integer
                  a nisl, in faucibus nunc et aenean turpis dui dignissim nec
                  scelerisque ullamcorper eu neque, augue quam quis lacus
                  pretium eros est amet turpis nunc in turpis massa et eget
                  facilisis ante molestie penatibus dolor volutpat, porta
                  pellentesque scelerisque at ornare dui tincidunt cras feugiat
                  tempor lectus
                </p>
                <div className={styles.postcard}>
                  <p>
                    Integer eu faucibus dolor <sup>[5]</sup>. Ut venenatis
                    tincidunt diam elementum imperdiet. Etiam accumsan semper
                    nisl eu congue. Sed aliquam magna erat, ac eleifend lacus
                    rhoncus in.
                  </p>
                </div>
                <p className={styles.para1}>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet
                  id enim, libero sit. Est donec lobortis cursus amet, cras
                  elementum libero convallis feugiat. Nulla faucibus facilisi
                  tincidunt a arcu, sem donec sed sed. Tincidunt morbi
                  scelerisque lectus non. At leo mauris, vel augue. Facilisi
                  diam consequat amet, commodo lorem nisl, odio malesuada cras.
                  Tempus lectus sed libero viverra ut. Facilisi rhoncus elit sit
                  sit.
                </p>
                ...
                <div className={styles.leavecomment}>
                  ...
                  <div className={styles.formcontainer}>
                    <div
                      className={`${styles.textarea} ${styles.marginbottom}`}
                    >
                      <textarea
                        rows={10}
                    ...
                    <div
                      className={`${styles.nameemail} ${styles.marginbottom}`}
                    >
