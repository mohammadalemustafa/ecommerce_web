        ...
        <div className={styles.navlistcont}>
          ...
          {click && (
            <div className={styles.browsedro}>
              ...
              <div className={styles.showMore}>
                ...
                {set ? (
                  <span onClick={Subdata}>show less</span>
                ) : (
                  <span onClick={adddata}>show more</span>
                )}
              </div>
            </div>
          )}
          <ul>
                    ...
                    {shopdata.map((item) => {
                      return (
                        <div className={styles.pages}>
                          ...
                          <span>{item.p8}</span>
                          <span>{item.p9}</span>
                          <span onClick={() => OnNavigate("/invoice")}>
                            {item.p10}
                          </span>
                          <span>{item.p11}</span>
                        </div>
            ...
            <li onMouseLeave={onmouseleave} onMouseEnter={handleMouse}>
              <span className={styles.megamanu}>
                Mega menu
                {mouse && (
                    ...
                    {pageslist.map((item) => {
                      return (
                        <div className={styles.pages}>
                          ...
                          <span onClick={() => OnNavigate("/contact")}>
                            {item.p2}
                          </span>
                          ...
                          <span onClick={() => OnNavigate("/register")}>
                            {item.p5}
                          </span>
                          <span onClick={() => OnNavigate("/forgotpass")}>
                            {item.p6}
                          </span>
                          <span onClick={() => OnNavigate("/resetpass")}>
                            {item.p7}
                          </span>
                          <span>{item.p8}</span>
                          <span onClick={() => OnNavigate("/privacy")}>
                            {item.p9}
                          </span>
                          <span onClick={() => OnNavigate("/TemsAndCondition")}>
                            {item.p10}
                          </span>
                        </div>
                      );
